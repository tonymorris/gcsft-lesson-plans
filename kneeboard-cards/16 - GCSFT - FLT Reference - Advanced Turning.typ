...
#let card = (
  ...
  sequence: (
    ...
    (badge: "dp", content: [*Slipping turn*: Patter: picture (turn rate apparent decrease), ball toward lower wing, aileron into turn; enter positivly; above Va; student practices entry, hold, recovery]),
    (badge: "d",  content: [*Skidding turn*: Patter: picture (turn rate apparent increase), ball toward lower wing, aileron out of turn; tempation to pitch up; spin risk; conduct above Va only; — *demo only; no student practice*]),
