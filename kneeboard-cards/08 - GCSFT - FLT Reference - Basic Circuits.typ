...
#let card = (
  ...
  sequence: (
    (badge: "d",  content: [*Circuit 1*: Instructor flies and narrates — every action, check, and radio call; BUMPFISH; gate at 300 ft assessed aloud; go-around PA(C)T; re-join]),
    (badge: "p",  content: [*Circuits 2-3*: Student takes control; instructor assists BUMPFISH and radio while student focuses on shape and height]),
