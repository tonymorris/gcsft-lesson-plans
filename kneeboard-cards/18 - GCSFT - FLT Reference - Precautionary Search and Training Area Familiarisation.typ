...
#let metadata = (
  ...
  unit: "Phase 3 — Lesson 2 | E14a + E9 check",
  author: "C.Moroney",
  version: "v1.0.0",
)
#let card = (
  ...
  sequence: (
    (badge: "p",  content: [*Departure/transit*: Student as PIC throughout; _awareness of landing fields_]),
    (badge: "p",  content: [*E9 CHECK:* _Student led, instructor silent observer_; HASSELL; steep turns 45° and 60° L and R; spiral dive check; instructor records S or NC]),
    ...
    (badge: "p",  content: [*Return*: Student as PIC; join circuit]),
    (badge: "p",  content: [*PSL practice — student at aerodrome*: Student selects "field"; 1000 ft first pass; approach to 500 ft second pass; states landing/reject decision with reasoning; third pass at 300 ft; PAN-PAN simulated]),
  ),
  centre: (
    (
      title: "ADM Framework",
  ...
  standards: [
    *E9 check recorded separately:* S confirmed (±5° bank, ±150 ft, spiral correct) or NC noted for remediation \
    *E14a Solo (S) — first of two flights:* PSL passes at correct heights (1000 ft ±150 ft, 500 ft ±100 ft); ADM applied aloud before entry; decision with correct reasoning; PAN-PAN without prompting; YSPT ERSA briefed
  ],
  safety: [
