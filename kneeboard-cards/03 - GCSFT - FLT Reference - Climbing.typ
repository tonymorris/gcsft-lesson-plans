...
#let card = (
  ...
  sequence: (
    ...
    (badge: "dp", content: [*Vy climb and level-off*: _PAT_ to establish; Vy ±5 kt, hdg ±5°; student practices; _Nose down + lookout every 500 feet_; anticipate level off, _APT_; ±100 ft]),
    ...
    (badge: "dp",  content: [*Upset recovery*: instructor induces an upset to attitude while in a climb; student returns to Vx or Vy attitude promptly and correctly]),
  ),
  errors: [
  ...
  standards: [
    *Progressing (P):* ASI +10/-5 kt, hdg ±8°; level-off ±200 ft; nose-down with reminders; returns to approximately correct climb attitude after upset, then corrects\
    *Solo (S):* ASI +5/-0 kt, hdg ±5°; level-off ±150 ft; nose-down without prompting; returns to correct climb attitude, without delay, after upset
  ],
  safety: [
