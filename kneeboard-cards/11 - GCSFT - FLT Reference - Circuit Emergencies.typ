...
#let card = (
  ...
  sequence: (
    (badge: "dp", content: [*RTO*: 3-step process — throttle, brakes + rearward elevator, directional control; *max 2 RTOs then 15 min brake cooldown*]),
    (badge: "dp", content: [*EFATO*: Nose down, throttle closed, land ahead; *no turn-back*; student patters landing area selection]),
    (badge: "dp", content: [*EFIC downwind*: Glide attitude; one-third aim point; turn base immediately; sideslip if high; student practices]),
    ...
    (badge: "dp", content: [*Flapless circuit*: Vapp +5 kt; attitude higher; shallower angle; longer rollout; student practices]),
    (badge: "p",  content: [*Low level circuit*: ~500 ft AGL — deteriorating weather scenario]),
    (badge: "p",  content: [*Partial power failure*: Instructor reduces without announcement; student makes continuation decision]),
  ...
  safety: [
    All sims briefed; student confirms · *Never simulate EFATO in a way that endangers aircraft* · Low-level EFATO: before landing threshold only; prohibited RWY 36 · Sideslip: never below 200 ft without runway assured
  ],
)
