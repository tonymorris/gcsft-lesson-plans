...
,aim: [
Build solo training area experience, consolidate all Phase 3 elements toward C standard, and maintain full independence in pre-flight administration.
]
...
- Describe the flight test standards for all Phase 3 elements
- Explain the self-brief requirements for a training area solo flight
- Identify the minimum experience requirements before Phase 4 commences
- Describe planning considerations for an alternate aerodrome diversion
...
- [SA] Full PIC situational awareness with no instructor on board; continuous airspace, traffic, and weather awareness
- [TEM] Identify and manage all training area threats without prompting; apply HASSELL discipline independently
- [ADM] Apply Time → Assess → Predict → Evaluate to any novel situation encountered during solo flight
...
- Theory exams: BAK, Air Legislation, Human Factors must be complete before Phase 4 commences
]

,ground_brief_topics: [
Total time: 15 minutes (solo days) / 25 minutes (dual check days) \
Equipment required: Student training record, VNC \

*Pre-Solo Self-Brief Template* (every solo session)
- NAIPS TAF/GAF/GPWT obtained and interpreted; conditions suitable for planned flight duration?
- BOM radar: precipitation checked as supplemental
- NOTAMs: checked; any restricted areas active?
- YSPT alternate: ERSA reviewed; frequency loaded as standby
...
- Review current standard for each Phase 3 element against C standard
...
- Spot-check student's weather interpretation: TAF/GAF/GPWT read correctly?
- Spot-check NOTAM brief: anything relevant missed?
- Spot-check maintenance release review: key items covered?
- Confirm area solo weather minima are met before student departs
- Observe solo flights; confirm student departs and returns safely; radio available on CTAF

#text(size:12pt)[*Student*]
- Access NAIPS independently; obtain TAF/GAF/GPWT; check BOM radar; brief instructor
- Check NOTAMs independently; brief instructor on any relevant items
- Review maintenance release independently; brief instructor on all items checked
- Complete IMSAFE self-assessment and operations whiteboard
- Deliver complete pre-solo brief to instructor using the self-brief template above
...
*Minimum requirements before advancing to Phase 4:*
- ☐ Sufficient solo training area experience for instructor to be confident all Phase 3 elements are at or approaching C standard
...
- *E16*: Both unusual attitude recoveries correct; fire actions from memory; ADM applied to novel scenarios
- *Pre-flight admin*: Fully independent; GAF/GPWT interpreted correctly; NOTAMs thorough; maintenance release reviewed and briefed clearly
- *Alternate aerodrome*: Can describe planning considerations for an unplanned diversion; correctly interprets YSPT ERSA entry; frequency loaded before every departure

- *Outcome*: Solo hours recorded in logbook and training record. Dual check results recorded per element. Phase 4 commences when minimum requirements are met.
]
...
,homework:[
- Complete any outstanding theory exams before Phase 4
